//from https://github.com/lit-forest/leaflet.migrationLayer
//MODIFIED by @hanumanum
...
(function (window) {
    ...
    var Marker = (function () {
        var M = function (options) {
            ...
            this.color = "#FF0000" //options.color;
            this.size = 3 //options.size;
    ...
    var Arc = (function () {
        ...
        A.prototype.draw = function (context) {
            ...
            context.save();
            //Text Color
            context.fillStyle = "#000" //this.strokeStyle;
            if (this.label) {
